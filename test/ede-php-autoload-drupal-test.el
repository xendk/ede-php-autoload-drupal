;;; ede-php-autoload-drupal-test.el --- Unit tests for ede-php-autoload-drupal.  -*- lexical-binding: t; -*-
...
;; We'll use fixtures for some tests.
(defvar ede-php-autoload-drupal-fixtures)

(ert-deftest ede-php-autoload-drupal--core-path-detects-core ()
  "`ede-php-autoload-drupal--core-path' should detect core."
  (should (equal
...
(ert-deftest ede-php-autoload-drupal--core-path-returns-nil-when-not-found ()
  "`ede-php-autoload-drupal--core-path' should return nil if not found."
  (should (equal
...
(ert-deftest ede-php-autoload-drupal--core-path-handles-multiple-paths ()
  "`ede-php-autoload-drupal--core-path' should take the first one if there's multiple."
  (should (equal
...
(ert-deftest ede-php-autoload-drupal--find-modules-finds-modules ()
  "`ede-php-autoload-drupal--find-modules' should find all modules in fixture."
...
(ert-deftest ede-php-autoload-drupal--filter-modules-filteres ()
  "`ede-php-autoload-drupal--filter-modules' should filter out blacklisted paths."
  (should (equal
...
(provide 'ede-php-autoload-drupal-test)
;;; ede-php-autoload-drupal-test.el ends here
